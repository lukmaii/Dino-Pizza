...
export class HomeComponent implements OnInit {
  ...
  public diagramLinkData: Array<go.ObjectData> = [
    ...
    { key: -6, from: 2, to: 1, segmentFraction: 0.5, points: [255, 1430, 225, 1350, 265, 685], text: 'ฮาวายเอียน' },
    { key: -9, from: 2, to: 2, segmentFraction: 0.4, points: [325, 1405, 325, 1375, 275, 1375, 275, 1405], segmentOffset: new go.Point(0, 25), text: 'ดับเบิ้ลชีส, เพิ่มชีส,\nไม่เพิ่มชีส, กลาง, ใหญ่,\nConfirm, Complete' },
    ...
    { key: -12, from: 3, to: 0, segmentFraction: 0.678, points: [550, 500, 550, 610, 670, 610, 670, 1825, 25, 1825, 25, 1045], text: 'Cancel' },
    { key: -13, from: 3, to: 3, segmentFraction: 0.5, points: [575, 405, 575, 375, 525, 375, 525, 405], segmentOffset: new go.Point(0, 25), text: 'ฮาวายเอียน, ดับเบิ้ลชีส,\nหนานุ่ม, เพิ่มชีส, ไม่เพิ่มชีส,\nConfirm, Complete' },
    { key: -14, from: 3, to: 4, segmentFraction: 0.5, points: [587, 485, 650, 785, 587, 815], text: 'บางกรอบ' },
    ...
    { key: -16, from: 4, to: 0, segmentFraction: 0.624, points: [550, 900, 550, 1010, 670, 1010, 670, 1825, 25, 1825, 25, 1045], text: 'Cancel' },
    { key: -14, from: 4, to: 3, segmentFraction: 0.5, points: [515, 815, 460, 785, 515, 485], text: 'หนานุ่ม' },
    ...
    { key: -18, from: 4, to: 9, segmentFraction: 0.70, points: [595, 825, 750, 750], text: 'กลาง' },
    { key: -19, from: 4, to: 10, segmentFraction: 0.70, points: [595, 875, 750, 950], text: 'ใหญ่' },
    ...
    { key: -21, from: 5, to: 5, segmentFraction: 0.5, points: [825, 1205, 825, 1175, 775, 1175, 775, 1205], segmentOffset: new go.Point(0, 25), text: 'ฮาวายเอี้ยน, ดับเบิ้ลชีส,\nหนานุ่ม, เพิ่มชีส, ไม่เพิ่มชีส,\nConfirm, Complete' },
    { key: -14, from: 5, to: 6, segmentFraction: 0.5, points: [837, 1285, 900, 1580, 837, 1615], text: 'บางกรอบ' },
    ...
    { key: -14, from: 6, to: 5, segmentFraction: 0.5, points: [765, 1615, 705, 1580, 765, 1285], text: 'หนานุ่ม' },
    { key: -25, from: 6, to: 6, segmentFraction: 0.5, points: [825, 1605, 825, 1575, 775, 1575, 775, 1605], segmentOffset: new go.Point(0, 25), text: 'ฮาวายเอี้ยน, ดับเบิ้ลชีส,\nบางกรอบ, เพิ่มชีส, ไม่เพิ่มชีส,\nConfirm, Complete' },
    ...
    { key: -29, from: 7, to: 11, segmentFraction: 0.5, points: [845, 325, 1005, 325], text: 'เพิ่มชีส' },
    { key: -30, from: 7, to: 7, segmentFraction: 0.5, points: [825, 305, 825, 275, 775, 275, 775, 305], segmentOffset: new go.Point(0, 25), text: 'ฮาวายเอียน, ดับเบิ้ลชีส,\nหนานุ่ม, บางกรอบ, กลาง,\nไม่เพิ่มชีส, Complete' },
    { key: -31, from: 7, to: 8, segmentFraction: 0.3, points: [755, 370, 730, 370, 730, 520, 760, 520], text: 'ใหญ่' },
    ...
    { key: -34, from: 8, to: 12, segmentFraction: 0.75, points: [845, 525, 1005, 525], text: 'เพิ่มชีส' },
    { key: -35, from: 8, to: 7, segmentFraction: 0.7, points: [840, 520, 865, 520, 865, 370, 845, 370], text: 'กลาง' },
    { key: -36, from: 8, to: 8, segmentFraction: 0.525, points: [825, 505, 825, 475, 775, 475, 775, 505], segmentOffset: new go.Point(0, 25), text: 'ฮาวายเอียน, ดับเบิ้ลชีส,\nหนานุ่ม, บางกรอบ, ใหญ่,\nไม่เพิ่มชีส, Complete' },
    ...
    { key: -39, from: 9, to: 13, segmentFraction: 0.75, points: [845, 725, 1005, 725], text: 'เพิ่มชีส' },
    { key: -40, from: 9, to: 9, segmentFraction: 0.525, points: [825, 705, 825, 675, 775, 675, 775, 705], segmentOffset: new go.Point(0, 25), text: 'ฮาวายเอียน, ดับเบิ้ลชีส,\nหนานุ่ม, บางกรอบ, กลาง,\nไม่เพิ่มชีส, Complete' },
    { key: -41, from: 9, to: 10, segmentFraction: 0.3, points: [755, 770, 730, 770, 730, 920, 760, 920], text: 'ใหญ่' },
    ...
    { key: -44, from: 10, to: 14, segmentFraction: 0.75, points: [845, 925, 1005, 925], text: 'เพิ่มชีส' },
    { key: -45, from: 10, to: 9, segmentFraction: 0.7, points: [840, 920, 865, 920, 865, 770, 845, 770], text: 'กลาง' },
    { key: -46, from: 10, to: 10, segmentFraction: 0.525, points: [825, 905, 825, 875, 775, 875, 775, 905], segmentOffset: new go.Point(0, 25), text: 'ฮาวายเอียน, ดับเบิ้ลชีส,\nหนานุ่ม, บางกรอบ, ใหญ่,\nไม่เพิ่มชีส, Complete' },
